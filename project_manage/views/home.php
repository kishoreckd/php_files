                ...
                <div class="flex items-center">
                    <div>
                        <form action="/undeleted" method="post" >
                            <button name="projectId" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type ="submit" value="<?php  echo $projectid?>">Un Deleted task<span>(<?=$undeletedcount[0]?>)</button>
                        </form>
                    </div>
                    ...
                    <div>
                        <form action="/deleted" method="post" >
                            <button name="projectId" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" type ="submit" value="<?php  echo $projectid?>">Deleted task <span>(<?=$deletedcount[0]?>)</button>
                        </form>
                    </div>
               <div class="div" style="visibility: hidden" >
                empty
